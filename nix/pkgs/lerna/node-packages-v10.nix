...
let
  sources = {
    ...
    "@octokit/graphql-4.7.0" = {
      ...
      version = "4.7.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@octokit/graphql/-/graphql-4.7.0.tgz";
        sha512 = "diY0qMPyQjfu4rDu3kDhJ9qIZadIm4IISO3RJSv9ajYUWJUCO0AykbgzLcg1xclxtXgzY583u3gAv66M6zz5SA==";
      };
    };
