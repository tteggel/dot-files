...
in
{
  artillery = nodeEnv.buildNodePackage {
    ...
    version = "1.6.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/artillery/-/artillery-1.6.0.tgz";
      sha512 = "vapCO+TR3EDf1Vg30xUEl+JasTBjctck9Hh3pvMW8RUDvXUv5gF+LanhsfkpZE3AwPGN1sEZ/9tbmnYGR913NQ==";
    };
    dependencies = [
